...
if($result2){
	...
	// echo'	</SCRIPT>';
	header('Location: grid_sesiones.php?nosesion='.$nosesion.'&tipo_sesion='.$tipo_sesion.'&desc_sesion='.$desc_sesion.'');
	exit;
} else{
	echo'	<SCRIPT LANGUAGE="javascript">';
	echo'alert("Ocurrió un error al consultar la información (SEL);")';
	echo'	</SCRIPT>';
}
