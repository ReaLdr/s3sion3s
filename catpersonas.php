...
//------------------------ PASO 1: CONSEGUIR ULTIMOS DATOS DE SESIONES ANTERIORES

	$filas = array();

	// cuantosTMP trae la ultima sesión
	$sql_countTMP="select id_distrito, id_sesion, id_integrante from sisesecd_cat_funcionarios where id_distrito = ".$id_distrito." and id_integrante=1 order by id_sesion DESC;";
...
$cliente ="";
	...
	$sql_count2="SELECT count(*) as cuantos2 FROM sisesecd_cat_funcionarios WHERE id_sesion =$_REQUEST[id_sesion] ";
		...
		/// CAMBIO A TABLA CAT_FUNCIONARIOS_CENTRAL
...
else
{
	...
	{
    echo'<tr>';
    echo'<td width="26%" rowspan="2">Partido Movimiento Regeneración Nacional (MORENA)</td>';
    echo'<td width="15%">';
...
<form id="frmClienteNuevo" name="frmClienteNuevo" method="post" onsubmit="return escondeNuevo();">
 ...
 <table width="89%" height="60" border="0">
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[0]["nombre"]?>" name= "txt_nombreCP" id="txt_nombreCP" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[0]["ap_paterno"]?>"  name= "txt_paternoCP" id="txt_paternoCP" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[0]["ap_materno"]?>" name= "txt_maternoCP" id="txt_maternoCP" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[1]["nombre"]?>" name= "txt_nombreSC" id="txt_nombreSC" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[1]["ap_paterno"]?>" name= "txt_paternoSC" id="txt_paternoSC" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[1]["ap_materno"]?>" name= "txt_maternoSC" id="txt_maternoSC" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[2]["nombre"]?>" name= "txt_nombreC1" id="txt_nombreC1" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[2]["ap_paterno"]?>" name= "txt_paternoC1" id="txt_paternoC1" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[2]["ap_materno"]?>" name= "txt_maternoC1" id="txt_maternoC1" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[3]["nombre"]?>" name= "txt_nombreC2" id="txt_nombreC2" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[3]["ap_paterno"]?>" name= "txt_paternoC2" id="txt_paternoC2" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[3]["ap_materno"]?>" name= "txt_maternoC2" id="txt_maternoC2" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[4]["nombre"]?>" name= "txt_nombreC3" id="txt_nombreC3" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[4]["ap_paterno"]?>" name= "txt_paternoC3" id="txt_paternoC3" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[4]["ap_materno"]?>" name= "txt_maternoC3" id="txt_maternoC3" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[5]["nombre"]?>" name= "txt_nombreC4" id="txt_nombreC4" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[5]["ap_paterno"]?>"  name= "txt_paternoC4" id="txt_paternoC4" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[5]["ap_materno"]?>" name= "txt_maternoC4" id="txt_maternoC4" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[6]["nombre"]?>" name= "txt_nombreC5" id="txt_nombreC5" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[6]["ap_paterno"]?>" name= "txt_paternoC5" id="txt_paternoC5" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[6]["ap_materno"]?>" name= "txt_maternoC5" id="txt_maternoC5" onkeypress='return validar_texto(event)'/></td>
   ...
   <tr>
     ...
     <td width="25%"><input type="text" value="<?php echo $filas[7]["nombre"]?>" name= "txt_nombreC6" id="txt_nombreC6" onkeypress='return validar_texto(event)'/></td>
     <td width="21%"><input type="text" value="<?php echo $filas[7]["ap_paterno"]?>" name= "txt_paternoC6" id="txt_paternoC6" onkeypress='return validar_texto(event)'/></td>
     <td width="22%"><input type="text" value="<?php echo $filas[7]["ap_materno"]?>"  name= "txt_maternoC6" id="txt_maternoC6" onkeypress='return validar_texto(event)'/></td>
...
<table width="91%" height="887" border="0">
    ...
    <tr>
      ...
      <td width="20%"><p>
       <input type="hidden" name="id_integra11" id="id_integra11" value ="11" checked="checked" />
        ...
        <input type="text" value="<?php echo $filas[8]["nombre"]?>" name= "txt_nombrePAN-P" id="txt_nombrePAN-P" onkeypress='return validar_texto(event)' tabindex="1" />
      </p>
        <p>
          <input type="text" value="<?php echo $filas[9]["nombre"]?>" name= "txt_nombrePAN-S" id="txt_nombrePAN-S" onkeypress='return validar_texto(event)' tabindex="4"/>
          <br />
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[8]["ap_paterno"]?>" name= "txt_paternoPAN-P" id="txt_paternoPAN-P" onkeypress='return validar_texto(event)' tabindex="2"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[9]["ap_paterno"]?>" name= "txt_paternoPAN-S" id="txt_paternoPAN-S" onkeypress='return validar_texto(event)' tabindex="5"/>
          <br />
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[8]["ap_materno"]?>" name= "txt_maternoPAN-P" id="txt_maternoPAN-P" onkeypress='return validar_texto(event)' tabindex="3"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[9]["ap_materno"]?>" name= "txt_maternoPAN-S" id="txt_maternoPAN-S" onkeypress='return validar_texto(event)' tabindex="6"/>
          <br />
        </p></td>
      <td width="12%"><p>
    ...
    <tr>
      ...
      <td width="20%"><p>
        ...
        <input type="text" value="<?php echo $filas[10]["nombre"]?>" name= "txt_nombrePRI-P" id="txt_nombrePRI-P" onkeypress='return validar_texto(event)' tabindex="7"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[11]["nombre"]?>" name= "txt_nombrePRI-S" id="txt_nombrePRI-S" onkeypress='return validar_texto(event)' tabindex="10"/>
          <br />
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[10]["ap_paterno"]?>" name= "txt_paternoPRI-P" id="txt_paternoPRI-P" onkeypress='return validar_texto(event)'tabindex="8"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[11]["ap_paterno"]?>" name= "txt_paternoPRI-S" id="txt_paternoPRI-S" onkeypress='return validar_texto(event)' tabindex="11"/>
          <br />
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[10]["ap_materno"]?>" name= "txt_maternoPRI-P" id="txt_maternoPRI-P" onkeypress='return validar_texto(event)' tabindex="9"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[11]["ap_materno"]?>" name= "txt_maternoPRI-S" id="txt_maternoPRI-S" onkeypress='return validar_texto(event)' tabindex="12"/>
          <br />
        </p></td>
      <td width="12%"><p>
    ...
    <tr>
      ...
      <td width="20%"><p>
        ...
        <input type="text" value="<?php echo $filas[12]["nombre"]?>" name= "txt_nombrePRD-P" id="txt_nombrePRD-P" onkeypress='return validar_texto(event)' tabindex="13"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[13]["nombre"]?>" name= "txt_nombrePRD-S" id="txt_nombrePRD-S" onkeypress='return validar_texto(event)' tabindex="16"/>
          <br />
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[12]["ap_paterno"]?>" name= "txt_paternoPRD-P" id="txt_paternoPRD-P" onkeypress='return validar_texto(event)' tabindex="14"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[13]["ap_paterno"]?>" name= "txt_paternoPRD-S" id="txt_paternoPRD-S" onkeypress='return validar_texto(event)' tabindex="17"/>
          <br />
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[12]["ap_materno"]?>" name= "txt_maternoPRD-P" id="txt_maternoPRD-P" onkeypress='return validar_texto(event)' tabindex="15"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[13]["ap_materno"]?>" name= "txt_maternoPRD-S" id="txt_maternoPRDP-S" onkeypress='return validar_texto(event)' tabindex="18"/>
          <br />
        </p></td>
      <td width="12%"><p>
    ...
    <tr>
      ...
      <td width="20%"><p>
        ...
        <p>
          <input type="text" value="<?php echo $filas[15]["nombre"]?>" name= "txt_nombrePVEM-S" id="txt_nombrePVEM-S" onkeypress='return validar_texto(event)' tabindex="22"/>
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[14]["ap_paterno"]?>" name= "txt_paternoPVEM-P" id="txt_paternoPVEM-P" onkeypress='return validar_texto(event)' tabindex="20"/>
      </p>
        <p>
       <input type="text" value="<?php echo $filas[15]["ap_paterno"]?>" name= "txt_paternoPVEM-S" id="txt_paternoPVEM-S" onkeypress='return validar_texto(event)' tabindex="23"/>
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[14]["ap_materno"]?>" name= "txt_maternoPVEM-P" id="txt_maternoPVEM-P" onkeypress='return validar_texto(event)' tabindex="21"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[15]["ap_materno"]?>" name= "txt_maternoPVEM-S" id="txt_maternoPVEM-S" onkeypress='return validar_texto(event)' tabindex="24"/>
        </p></td>
      <td width="12%"><p>
      ...
      <td width="20%"><p>
        ...
        <input type="text" value="<?php echo $filas[16]["nombre"]?>" name= "txt_nombrePT-P" id="txt_nombrePT-P" onkeypress='return validar_texto(event)' tabindex="25"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[17]["nombre"]?>" name= "txt_nombrePT-S" id="txt_nombrePT-S" onkeypress='return validar_texto(event)' tabindex="28"/>
          <br />
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[16]["ap_paterno"]?>" name= "txt_paternoPT-P" id="txt_paternoPT-P" onkeypress='return validar_texto(event)' tabindex="26"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[17]["ap_paterno"]?>" name= "txt_paternoPT-S" id="txt_paternoPT-S" onkeypress='return validar_texto(event)' tabindex="29"/>
          <br />
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[16]["ap_materno"]?>" name= "txt_maternoPT-P" id="txt_maternoPT-P" onkeypress='return validar_texto(event)' tabindex="27"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[17]["ap_materno"]?>" name= "txt_maternoPT-S" id="txt_maternoPT-S" onkeypress='return validar_texto(event)' tabindex="30"/>
          <br />
        </p></td>
      <td width="12%">
<p>
...
<p>
    ...
    <tr>
      ...
      <td width="20%"><p>
       <input type="hidden" name="id_integra16" id="id_integra16" value ="16" />
        <input type="text" value="<?php echo $filas[18]["nombre"]?>" name= "txt_nombrePMC-P" id="txt_nombrePMC-P" onkeypress='return validar_texto(event)' tabindex="31"/>
     </p>
          <input type="text" value="<?php echo $filas[19]["nombre"]?>" name= "txt_nombrePMC-S" id="txt_nombrePMC-S" onkeypress='return validar_texto(event)' tabindex="34"/>
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[18]["ap_paterno"]?>" name= "txt_paternoPMC-P" id="txt_paternoPMC-P" onkeypress='return validar_texto(event)' tabindex="32"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[19]["ap_paterno"]?>" name= "txt_paternoPMC-S" id="txt_paternoPMC-S" onkeypress='return validar_texto(event)' tabindex="35"/>
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[18]["ap_materno"]?>" name= "txt_maternoPMC-P" id="txt_maternoPMC-P" onkeypress='return validar_texto(event)' tabindex="33"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[19]["ap_materno"]?>" name= "txt_maternoPMC-S" id="txt_maternoPMC-S" onkeypress='return validar_texto(event)' tabindex="36"/>
        </p></td>
      <td width="12%"><p>
    ...
    <tr>
     <td width="25%">Partido Movimiento Regeneración Nacional (MORENA)</td>
      <td width="20%"><p>
        ...
        <input type="text" value="<?php echo $filas[20]["nombre"]?>" name="txt_nombreMOR-P" id="txt_nombreMOR-P" onkeypress='return validar_texto(event)' tabindex="43"/>
        </p>
        <p>
        <input type="text" value="<?php echo $filas[21]["nombre"]?>" name="txt_nombreMOR-S" id="txt_nombreMOR-S" onkeypress='return validar_texto(event)' tabindex="46"/>
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[20]["ap_paterno"]?>" name="txt_paternoMOR-P" id="txt_paternoMOR-P" onkeypress='return validar_texto(event)' tabindex="44"/>
        </p>
        <p>
        <input type="text" value="<?php echo $filas[21]["ap_paterno"]?>" name="txt_paternoMOR-S" id="txt_paternoMOR-S" onkeypress='return validar_texto(event)' tabindex="47"/>
       </p></td>
      <td width="22%">
        <input type="text" value="<?php echo $filas[20]["ap_materno"]?>" name="txt_maternoMOR-P" id="txt_maternoMOR-P" onkeypress='return validar_texto(event)' tabindex="45"/>
      </p>
      <p>
       <input type="text" value="<?php echo $filas[21]["ap_materno"]?>" name="txt_maternoMOR-S" id="txt_maternoMOR-S" onkeypress='return validar_texto(event)' tabindex="48"/>
      </p></td>
      <td width="12%"><p>
  ...
  <tr>
      ...
      <td width="20%"><p>
        ...
        <p>
          <input type="text" value="<?php echo $filas[23]["nombre"]?>" name= "txt_nombrePES-S" id="txt_nombrePES-S" onkeypress='return validar_texto(event)' tabindex="52"/>
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[22]["ap_paterno"]?>" name= "txt_paternoPES-P" id="txt_paternoPES-P" onkeypress='return validar_texto(event)' tabindex="50"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[23]["ap_paterno"]?>" name= "txt_paternoPES-S" id="txt_paternoPES-S" onkeypress='return validar_texto(event)' tabindex="53"/>
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[22]["ap_materno"]?>" name= "txt_maternoPES-P" id="txt_maternoPES-P" onkeypress='return validar_texto(event)' tabindex="51"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[23]["ap_materno"]?>" name= "txt_maternoPES-S" id="txt_maternoPES-S" onkeypress='return validar_texto(event)' tabindex="54"/>
        </p></td>
...
S </td>
     ...
     <tr>
      ...
      <td width="20%"><p>
        ...
        <p>
          <input type="text" value="<?php echo $filas[27]["nombre"]?>" name= "txt_nombrePFSM-S" id="txt_nombrePFSM-S" onkeypress='return validar_texto(event)' tabindex="58"/>
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[26]["ap_paterno"]?>" name= "txt_paternoPFSM-P" id="txt_paternoPFSM-P" onkeypress='return validar_texto(event)' tabindex="56"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[27]["ap_paterno"]?>" name= "txt_paternoPFSM-S" id="txt_nombrePFSM-S" onkeypress='return validar_texto(event)' tabindex="59"/>
        </p></td>
      <td width="22%"><p>
        <input type="text" value="<?php echo $filas[26]["ap_materno"]?>" name= "txt_maternoPFSM-P" id="txt_maternoPFSM-P" onkeypress='return validar_texto(event)' tabindex="57"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[27]["ap_materno"]?>" name= "txt_maternoPFSM-S" id="txt_maternoPFSM-S" onkeypress='return validar_texto(event)' tabindex="60"/>
        </p></td>
      <td width="12%"><p>
...
<table width="91%" height="60" border="0">
    ...
    <tr>
      ...
      <td width="19%"><p>
       <input type="hidden" name="id_integra31" id="id_integra31" value ="31" />
        <input type="text" value="<?php echo $filas[30]["nombre"]?>" name= "txt_nombreCI1-P" id="txt_nombreCI1-P" onkeypress='return validar_texto(event)' tabindex="61"/>
      </p>
        <p>
          <input type="text" value="<?php echo $filas[31]["nombre"]?>" name= "txt_nombreCI1-S" id="txt_nombreCI1-S" onkeypress='return validar_texto(event)' tabindex="64"/>
        </p></td>
      <td width="21%"><p>
        <input type="text" value="<?php echo $filas[30]["ap_paterno"]?>" name= "txt_paternoCI1-P" id="txt_paternoCI1-P" onkeypress='return validar_texto(event)' tabindex="62"/>
      </p>
      <p>
      <input type="text" value="<?php echo $filas[31]["ap_paterno"]?>" name= "txt_paternoCI1-S" id="txt_paternoCI1-S" onkeypress='return validar_texto(event)' tabindex="65"/>
      </p></td>
      <td width="24%"><p>
        <input type="text" value="<?php echo $filas[30]["ap_materno"]?>" name= "txt_maternoCI1-P" id="txt_paternoCI1-P" onkeypress='return validar_texto(event)' tabindex="63"/>
      </p>
      <p>
          <input type="text" value="<?php echo $filas[31]["ap_materno"]?>" name= "txt_maternoCI1-S" id="txt_maternoCI1-S" onkeypress='return validar_texto(event)' tabindex="66"/>
        </p></td>
    ...
    <tr>
      ...
      <td width="19%"><p>
       ...
       <input type="text" value="<?php echo $filas[32]["nombre"]?>" name="txt_nombreCI2-P" id="txt_nombreCI2-P" onkeypress='return validar_texto(event)' tabindex="67"/>
       </p>
        <p><input type="text" value="<?php echo $filas[33]["nombre"]?>" name="txt_nombreCI2-S" id="txt_nombreCI2-S" onkeypress='return validar_texto(event)' tabindex="70"/>
        </p></td>
       <td width="21%"><p>
       <input type="text" value="<?php echo $filas[32]["ap_paterno"]?>" name="txt_paternoCI2-P" id="txt_paternoCI2-P" onkeypress='return validar_texto(event)' tabindex="68"/>
       </p>
       <p>
       <input type="text" value="<?php echo $filas[33]["ap_paterno"]?>" name="txt_paternoCI2-S" id="txt_paternoCI2-S" onkeypress='return validar_texto(event)' tabindex="71"/>
       </p></td>
       <td width="24%"><p>
       <input type="text" value="<?php echo $filas[32]["ap_materno"]?>" name="txt_maternoCI2-P" id="txt_maternoCI2-P" onkeypress='return validar_texto(event)' tabindex="69"/>
       </p>
       <p>
       <input type="text" value="<?php echo $filas[33]["ap_materno"]?>" name="txt_maternoCI2-S" id="txt_maternoCI2-S" onkeypress='return validar_texto(event)' tabindex="72"/>
       </p></td>
    ...
    <tr>
      ...
      <td width="19%"><p>
       ...
       <input type="text" value="<?php echo $filas[34]["nombre"]?>" name="txt_nombreCI3-P" id="txt_nombreCI3-P" onkeypress='return validar_texto(event)' tabindex="73"/>
       </p>
       <p>
       <input type="text" value="<?php echo $filas[35]["nombre"]?>" name="txt_nombreCI3-S" id="txt_nombreCI3-S" onkeypress='return validar_texto(event)' tabindex="76"/>
       </p></td>
       <td width="21%"><p>
        <input type="text" value="<?php echo $filas[34]["ap_paterno"]?>" name="txt_paternoCI3-P" id="txt_paternoCI3-P" onkeypress='return validar_texto(event)' tabindex="74"/>
       </p>
       <p>
       <input type="text" value="<?php echo $filas[35]["ap_paterno"]?>" name="txt_paternoCI3-S" id="txt_paternoCI3-S" onkeypress='return validar_texto(event)' tabindex="76"/>
        </p></td>
      <td width="24%"><p>
        <input type="text" value="<?php echo $filas[34]["ap_materno"]?>" name="txt_maternoCI3-P" id="txt_maternoCI3-P" onkeypress='return validar_texto(event)' tabindex="75"/>
        </p>
        <p>
        <input type="text" value="<?php echo $filas[35]["ap_materno"]?>" name="txt_maternoCI3-S" id="txt_maternoCI3-S" onkeypress='return validar_texto(event)' tabindex="77"/>
        </p></td>
