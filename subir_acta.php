	...
	if ($tamano < $upload_max)
		...
		//if ($tipo == "application/pdf")
			//{
						...
						$prefijo =$id_distrito."-".$id_sesion."-".$alea.$today;
						...
						if ($archivo != "")
						 {
							...
							$destino =  "actas/".$prefijo;
									...
									{	
										...
										$update_imagen="UPDATE sisesecd_sesiones SET acta_principal='$nombre_imagen' WHERE id_sesion=$id_sesion and id_distrito=$id_distrito";
									//echo $update_imagen;
									//exit;
								...
								$accion="Se subio el Acta";
								bitacora($accion);

									echo '<SCRIPT LANGUAGE="javascript">';
							
									echo 'alert("El archivo PDF se ha guardado Exitosamente")';
									...
									{
									echo '<SCRIPT LANGUAGE="javascript">';
									echo 'alert("Error al subir el archivo verifique el tamaño y la extension  .PDF")';
									echo '</SCRIPT>';
									}
					...
					{
			     	echo '<SCRIPT LANGUAGE="javascript">';
					echo 'alert("Solo se Permiten subir Archivos con extension.PDF")';
					echo '</SCRIPT>';
					}
			...
			{
			echo '<SCRIPT LANGUAGE="javascript">';
			echo 'alert("Error al subir el archivo, El tamaño del PDF  excede el tamaño a 4MB)';
			echo '</SCRIPT>';
			}		
...
<table width="413" border="0" cellspacing="0" cellpadding="0">
  ...
  <form action="subir_acta.php" method="post" enctype="multipart/form-data">
    <td class="text">
      <input name="archivo" type="file" class="casilla" id="archivo" size="35" /></td>
