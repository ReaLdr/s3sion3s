...
echo "</th>";
echo "<th colspan=6>";
echo "<font style='font-size:14px;font-weight:bold;'> REPORTE CENTRAL DE ACTIVIDADES DESARROLLADAS POR LOS &Oacute;RGANOS DESCONCENTRADOS						
<font><br>";
echo "</th>";
...
//$sql="select * from sisecao_actividades  INNER JOIN sisecao_catactividad ON
//sisecao_actividades.'id_actividad' = sisecao_catactividad.'clave' where sisecao_actividades.status =1 order by sisecao_actividades.'id_actividad' ";
