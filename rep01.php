...
echo "<font style='font-size:14px;font-weight:bold;'>FECHA DEL DÍA:".$dia." DEL MES ".$mes." DE ".$anio."</font><br>";
echo "</td>";
echo "</tr>";
/*echo"<th colspan=30>";
...
/// Empieza la tabla de fin de la sesión 
...
$duracion=calcular_tiempo_trasnc($datos_fin['hora_inicio_real'],$datos_fin['hora_fin_final']);
	...
	echo'<td align="center" class="resultados">morena'.$datos_fin['qf_morena_p'].'</td>';
	echo'<td align="center" class="resultados">morena'.$datos_fin['qf_morena_s'].'</td>';
	echo'<td align="center" class="resultados">elg'.$datos_fin['qf_elg_p'].'</td>';
	echo'<td align="center" class="resultados">elg'.$datos_fin['qf_elg_s'].'</td>';
	
	echo'<td align="center" class="resultados">pes'.$datos_fin['qf_pes_p'].'</td>';
	echo'<td align="center" class="resultados">pes'.$datos_fin['qf_pes_s'].'</td>';
	echo'<td align="center" class="resultados">prsp'.$datos_fin['qf_prsp_p'].'</td>';
	echo'<td align="center" class="resultados">prsp'.$datos_fin['qf_prsp_s'].'</td>';

	echo'<td align="center" class="resultados">pfsm'.$datos_fin['qf_pfsm_p'].'</td>';
	echo'<td align="center" class="resultados">pfsm'.$datos_fin['qf_pfsm_s'].'</td>';
