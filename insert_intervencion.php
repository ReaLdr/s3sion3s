...
<?php
	...
	$nosesion = htmlspecialchars(trim($_REQUEST['nosesion']));
	$tiposesion = htmlspecialchars(trim($_REQUEST['tiposesion']));
	...
	$tmpSQL="INSERT INTO intervenciones(idsesion,idorden, tipointervencion, inter_cp, inter_c1,inter_c2, inter_c3, inter_c4, inter_c5, inter_c6, inter_se, inter_panp, inter_pans, inter_prip, inter_pris, inter_prdp, inter_prds, inter_ptp, inter_pts, inter_pvemp, inter_pvems, inter_convp, inter_convs, inter_pnap, inter_pnas, inter_psp,inter_pss,intervencion,replica) values (".$idsesion.", ".$idorden.", 0, ".$inter_cp.", ".$inter_c1.", ".$inter_c2.",  ".$inter_c3.", ".$inter_c4.", ".$inter_c5.", ".$inter_c6.", ".$inter_se.", ".$inter_panp.", ".$inter_pans.", ".$inter_prip.", ".$inter_pris.", ".$inter_prdp.", ".$inter_prds.", ".$inter_ptp.", ".$inter_pts.", ".$inter_pvemp.", ".$inter_pvems.", ".$inter_convp.", ".$inter_convs.", ".$inter_pnap.", ".$inter_pnas.",".$inter_psp.",".$inter_pss.", '".$intervencion."','".$replica."');";
//echo $tmpSQL;
...
$sql_update="UPDATE sesiones SET con_intervencion =1 WHERE idsesion=$idsesion";
		...
		echo'<table width="166" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			<td align="center">GUARDANDO...</td>
		  </tr>
		</table>';

		echo'<SCRIPT LANGUAGE="javascript">';
		echo'alert("La Intervención creo Exitosamente");';
