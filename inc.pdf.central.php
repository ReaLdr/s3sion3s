...
function Header()
{
 if($this->sinvalor==1) $this->temporal("Documento sin valor");
   ...
   $mesreal=substr($this->fechainicioreal,5,2);
   $mes = array(" ","Enero","Febrero", "Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
    $tiposes="S/T";
    if($this->tiposesion==1) $tiposes="Ordinaria";
    if($this->tiposesion==2) $tiposes="Extraordinaria";
    if($this->tiposesion==2) $tiposes="Permanente";
    // Logo
    $this->Image('images/logo2012.gif',10,8,33);
    // Arial bold 15
    ...
    $this->Cell(120);
    // Título
    $this->Cell(30,10,'Consejos Distritales',0,0,'C');
    ...
    $this->Cell(120);
    // Título
    $this->Cell(30,10,$this->nosesion.' '.$tiposes.' del '.$diareal.' de '.$mes[$mesreal].' de 2012',0,1,'C');
...
$this->Cell(100,16,"Proyecto o punto de acuerdo",1,0,"C");  // HORA
$this->Cell(68,8,"Sentido de la votación",1,0,"C");  // HORA
$this->Cell(0,16,"Observaciones",1,1,"C");  // HORA
$this->SetY(58);
$this->SetX(110); //columnas
$this->Cell(17,8,"Unanime",1,0,"C");
$this->Cell(17,8,"A favor",1,0,"C");
$this->Cell(17,8,"En contra",1,0,"C");
