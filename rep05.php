...
echo "<font style='font-size:14px;font-weight:bold;'>FECHA DE LA SESI&Oacute;N: ".$dia." DEL MES ",$mes." DE 2021</font><br>";
echo "</td>";
echo "</tr>";
echo '<tr>';
...
echo "<th class='borde_tabla'>Punto de Intervenci&oacute;n</th>";
