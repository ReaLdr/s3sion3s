...
include 'config_open_db.php';
	...
	include("bitacora.php");
			$accion="GeneraReporte IntegracionConsejo CENTRAL";
			bitacora($accion);
...
//echo "<font style='font-size:14px;font-weight:bold;'>FECHA DEL D�A: ".$dia." DEL MES ".$month[$mes]." DE" .$anio." </font><br>";
...
where nosesion=$n_sesion and tipo_sesion=$t_sesion
and desc_sesion=$desc and id_distrito!=40 and estatus=1 and id_distrito=$iddistrito )";
