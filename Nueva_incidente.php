...
//	}
	...
	if (sqlsrv_query($conn,$tmpSQL)== true){
		...
		if (sqlsrv_query($conn,$sql_update)== true){
					echo'<SCRIPT LANGUAGE="javascript">';
					echo'alert("El Incidente se guardó Exitosamente")';
					echo'</SCRIPT>';
					echo'<SCRIPT LANGUAGE="javascript">';
					echo'history.go(-2)
					history.back()';
...
echo'</tr>';
	...
	//echo'<tr>';
		...
		echo '<td colspan="2">';
		echo '<input type="checkbox" name="ck_c5" value="1"> C5';
		echo '</td>';
		}
...
<input type="hidden" value="<?php  echo $_REQUEST["page"] ?>" id="page" name="page" />
  ...
  <table style="width: 90%;" border="1">
   ...
   <td width="0%"><input type="radio" name="prd" value="2"/>
    ...
    <td width="0%"><input type="radio" name="pt" value="2"  />
        <br />
        S </td>
    <td><input type="radio" name="pmc" value="1"  />
        <br />
        P </td>
    ...
    <tr>
      ...
      <td width="0%"><input type="radio" name="prsp" value="2" />
        <br />
        S </td>
       <td width="0%"><input type="radio" name="pfsm" value="1" />
        <br />
        P </td>
  ...
  <td><input type="radio" name="ci1" value="1"  />
    <br />
    P </td>
    <td width="0%"><input type="radio" name="ci1" value="2" />
    <br />
    S </td>
    <td><input type="radio" name="ci2" value="1" />
    <br />
    P </td>
    <td width="0%"><input type="radio" name="ci2" value="2"  />
    <br />
    S </td>
    <td><input type="radio" name="ci3" value="1"  />
    <br />
    P </td>
    <td width="0%"><input type="radio" name="ci3" value="2"  />
    <br />
    S </td>
     <td><input type="radio" name="ci4" value="1"  />
    <br />
    P </td>
    <td width="0%"><input type="radio" name="ci4" value="2" />
    <br />
    S </td>
    </tr>
  </table>
